...
const MARKET_DATA = [
  ...
  { symbol: "RELIANCE", price: "2,954", change: "+0.5%", pos: true },
  { symbol: "TCS", price: "3,950", change: "+0.4%", pos: true },
  { symbol: "HDFCBANK", price: "1,528", change: "-0.2%", pos: false },
];
    ...
    <div className="db-overview">
      ...
      <div className="db-stats-row">
        {[
          ...
          {
            label: "Total P / L",
            value: `${isGain ? "+" : "-"}₹${Math.abs(totalPL).toLocaleString("en-IN", {
                  ...
                  <div key={h.symbol} className="db-holding-row">
                    ...
                    <div className="db-holding-right">
                      <span className="db-holding-val">
                        ₹{(h.currentPrice * h.qty).toLocaleString("en-IN", { maximumFractionDigits: 0 })}
                      </span>
