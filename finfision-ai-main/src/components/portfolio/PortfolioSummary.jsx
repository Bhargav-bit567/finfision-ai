...
const PortfolioSummary = () => {
  ...
  const initialValue = 100000 + holdings.reduce((acc, stock) => acc + stock.qty * stock.avgPrice, 0);
    ...
    <div className="portfolio-summary-grid">
      {stats.map((stat, i) => {
        ...
        const sparkPath = sparkPts
          ...
          .join(" ");
        const firstY = sparkPts.split(" ")[0]?.split(",")[1] || 15;
        ...
        return (
          ...
          >
            ...
            <svg className="sparkline-svg" viewBox="0 0 100 30" preserveAspectRatio="none">
               ...
               />
               <path 
                 d={`M 0 30 L 0 ${firstY} ${sparkPath.replace(/^M/, "L")} L 100 30 Z`} 
