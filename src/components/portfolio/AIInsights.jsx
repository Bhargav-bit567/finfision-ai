...
const AIInsights = () => {
  const { trades, fearScore, interactionCount } = useBehaviorStore();
  ...
  const getInsights = () => {
    ...
    if (fearScore > 75) {
      insights.push({
        ...
        message: "Your fear index is critical. Consider taking a 5-minute break to reset your decision-making baseline."
      });
    }
